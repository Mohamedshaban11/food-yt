  ...
  return (
    <div className=" max-w-[1640px] m-auto px-4 py-12">
      ...
      <div className=" flex flex-col lg:flex-row justify-between">
        {/*filter type*/}
        <div>
          <p className=" font-bold text-gray-700">Food's Type</p>
        ...
        {/*filter price*/}
        <div>
          <p className="font-bold text-gray-700">Food Price</p>
          <div className=" justify-between flex max-w-[390px] w-full">
            <button
              onClick={() => filterPrice("$")}
              className=" border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white m-1"
            >
